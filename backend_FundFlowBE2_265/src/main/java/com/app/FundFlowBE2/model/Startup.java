package com.app.FundFlowBE2.model;
...
import com.app.FundFlowBE2.converter.DurationConverter;
import com.app.FundFlowBE2.converter.UUIDToByteConverter;
import com.app.FundFlowBE2.converter.UUIDToStringConverter;
...
@Entity(name = "Startup")
@Table(name = "\"Startup\"", schema =  "\"fundflowbe62\"")
@Data
...
@Column(name = "\"KeyMetrics\"")
    ...
    @CollectionTable(schema = "\"fundflowbe62\"", name = "\"StartupKeyMetrics\"",joinColumns = @JoinColumn(name = "\"SId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FId\""), schema = "\"fundflowbe62\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"SId\""),
            inverseJoinColumns = @JoinColumn( name="\"RoundId\""), schema = "\"fundflowbe62\"")
